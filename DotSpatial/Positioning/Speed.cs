...
// | Rico (Rico Castelo)      | 11/22/2011 | Added mm/s
// | Rico (Rico Castelo)      | 12/08/2011 | Changed namespace to RTI
// ********************************************************************************************************
using System;
...
namespace DotSpatial.Positioning
{
    ...
    public struct Speed : IFormattable, IComparable<Speed>, IEquatable<Speed>, IXmlSerializable
    {
        ...
        /// <summary>
        /// Millimeters per second to Knots.
        /// </summary>
        private const double MMPS_PER_KNOT = 0.001943845;
        /// <summary>
        ///
        /// </summary>
        ...
        /// <summary>
        /// Millimeters per second to Miles per hour.
        /// </summary>
        private const double MMPS_PER_STATUTE_MPH = 0.002236936;
        /// <summary>
        ///
        /// </summary>
        ...
        /// <summary>
        /// Millimeters per second to Kilometers per hour.
        /// </summary>
        private const double MMPS_PER_KPH = 0.0036;
        /// <summary>
        ///
        /// </summary>
        ...
        /// <summary>
        /// Millimeters per second to Kilometers per second.
        /// </summary>
        private const double MMPS_PER_KPS = 0.000001;
        /// <summary>
        ///
        /// </summary>
        ...
        /// <summary>
        /// Millimeters per second to Feet per Second
        /// </summary>
        private const double MMPS_PER_FPS = 0.00328084;
        /// <summary>
        ///
        /// </summary>
        ...
        /// </summary>
        private const double MMPS_PER_MPS = 0.001;

        /// <summary>
        ///
        /// </summary>
        private const double KNOTS_PER_MMPS = 514.44444444;
        /// <summary>
        ///
        /// </summary>
        private const double STATUTE_MPH_PER_MMPS = 447.04;
        /// <summary>
        ///
        /// </summary>
        private const double FPS_PER_MMPS = 304.8;
        /// <summary>
        ///
        /// </summary>
        private const double KPH_PER_MMPS = 277.777778;
        /// <summary>
        ///
        /// </summary>
        private const double KPS_PER_MMPS = 1000000;
        /// <summary>
        /// Meters per second to millimeters per second.
        /// </summary>
        private const double MPS_PER_MMPS = 1000;
        ...
        /// <summary>
        /// Represents an bad Velocity in DVL mode.
        /// </summary>
        public static readonly Speed BadDVL = new Speed(-99999, SpeedUnit.MillimetersPerSecond);
        /// <summary>
        /// Represents an bad Velocity in Profile mode.
        /// </summary>
        public static readonly Speed BadProfile = new Speed(88.888F, SpeedUnit.MetersPerSecond);
        ...
        public Speed(string value, CultureInfo culture)
        {
            ...
            try
            {
                ...
                string tempUnits = unit.ToUpper(CultureInfo.InvariantCulture).Trim()
                    ...
                    .Replace("METER", "M")
                    .Replace("METRE", "M")
                    // Replace "millimeter" synonyms
                    .Replace("MILLIMETERS", "MM")
                    .Replace("MILLIMETRES", "MM")
                    .Replace("MILLIMETER", "MM")
                    .Replace("MILLIMETRE", "MM")
                ...
                switch (tempUnits)
                {
                    ...
                    case "M/S":
                        ...
                        break;
                    case "MM/S":
                        _units = SpeedUnit.MillimetersPerSecond;
                        break;
                    case "MI/H":
                        _units = SpeedUnit.StatuteMilesPerHour;
                        break;
                    default:
                        throw new FormatException(RTI.Properties.Resources.Speed_InvalidUnitPortion);
                }
            }
            catch (Exception ex)
            {
...
#else
                throw new ArgumentException(RTI.Properties.Resources.Speed_InvalidFormat, "value", ex);
#endif
            }
        }
        ...
        public Speed ToFeetPerSecond() //'Implements ISpeed.ToFeetPerSecond
        {
            switch (Units)
            {
                ...
                case SpeedUnit.MillimetersPerSecond:
                    return new Speed(Value * MMPS_PER_FPS, SpeedUnit.FeetPerSecond);
        ...
        public Speed ToKilometersPerHour() //'Implements ISpeed.ToKilometersPerHour
        {
            switch (Units)
            {
                ...
                case SpeedUnit.MillimetersPerSecond:
                    return new Speed(Value * MMPS_PER_KPH, SpeedUnit.KilometersPerHour);
                case SpeedUnit.Knots:
        ...
        public Speed ToKilometersPerSecond() //'Implements ISpeed.ToKilometersPerSecond
        {
            switch (Units)
            {
                ...
                case SpeedUnit.MillimetersPerSecond:
                    return new Speed(Value * MMPS_PER_KPS, SpeedUnit.KilometersPerSecond);
                case SpeedUnit.Knots:
        ...
        public Speed ToKnots() //'Implements ISpeed.ToKnots
        {
            switch (Units)
            {
                ...
                case SpeedUnit.MillimetersPerSecond:
                    return new Speed(Value * MMPS_PER_KNOT, SpeedUnit.Knots);
                case SpeedUnit.Knots:
                    return this;
                default:
                    return Empty;
        ...
        public Speed ToMetersPerSecond() //'Implements ISpeed.ToMetersPerSecond
        {
            switch (Units)
            {
                ...
                case SpeedUnit.MetersPerSecond:
                    return this;
                case SpeedUnit.MillimetersPerSecond:
                    return new Speed(Value * MMPS_PER_MPS, SpeedUnit.MetersPerSecond);
                case SpeedUnit.Knots:
        ...
        /// <summary>
        /// Returns the current instance converted to millimeters per second.
        /// </summary>
        /// <returns></returns>
        /// <remarks>The measurement is converted regardless of its current unit type.</remarks>
        public Speed ToMillimetersPerSecond() //'Implements ISpeed.ToMetersPerSecond
        {
            switch (Units)
            {
                case SpeedUnit.StatuteMilesPerHour:
                    return new Speed(Value * STATUTE_MPH_PER_MMPS, SpeedUnit.MillimetersPerSecond);
                case SpeedUnit.KilometersPerHour:
                    return new Speed(Value * KPH_PER_MMPS, SpeedUnit.MillimetersPerSecond);
                case SpeedUnit.KilometersPerSecond:
                    return new Speed(Value * KPS_PER_MMPS, SpeedUnit.MillimetersPerSecond);
                case SpeedUnit.FeetPerSecond:
                    return new Speed(Value * FPS_PER_MMPS, SpeedUnit.MillimetersPerSecond);
                case SpeedUnit.MillimetersPerSecond:
                    return this;
                case SpeedUnit.MetersPerSecond:
                    return new Speed(Value * MPS_PER_MMPS, SpeedUnit.MillimetersPerSecond);
                case SpeedUnit.Knots:
                    return new Speed(Value * KNOTS_PER_MMPS, SpeedUnit.MillimetersPerSecond);
                default:
                    return Empty;
            }
        }
        ...
        public Speed ToStatuteMilesPerHour()
        {
            switch (Units)
            {
                ...
                case SpeedUnit.MillimetersPerSecond:
                    return new Speed(Value * MMPS_PER_STATUTE_MPH, SpeedUnit.StatuteMilesPerHour);
                case SpeedUnit.Knots:
        ...
        public Speed ToMetricUnitType()
        {
            ...
            if (Math.Abs(temp.Value) < 1.0)
                temp = temp.ToMillimetersPerSecond();
        ...
        /// <summary>
        /// Froms the millimeters per second.
        /// </summary>
        /// <param name="value">The value.</param>
        /// <returns></returns>
        /// <remarks></remarks>
        ...
        {
            return new Speed(value, SpeedUnit.MillimetersPerSecond);
        }
        ...
        public string ToString(string format, IFormatProvider formatProvider)
        {
                        ...
                        case 2:
                            switch (Units)
                            {
                                ...
                                case SpeedUnit.MetersPerSecond:
                                    ...
                                    break;
                                case SpeedUnit.MillimetersPerSecond:
                                    format = format.Replace("UU", "mm/sec");
                                    break;
                                case SpeedUnit.StatuteMilesPerHour:
                        ...
                        case 3:
                            switch (Units)
                            {
                                ...
                                case SpeedUnit.MetersPerSecond:
                                    ...
                                    break;
                                case SpeedUnit.MillimetersPerSecond:
                                    format = format.Replace("UUU", "millimeters/second");
                                    break;
                                case SpeedUnit.StatuteMilesPerHour:
                        ...
                        case 4:
                            switch (Units)
                            {
                                ...
                                case SpeedUnit.MetersPerSecond:
                                    ...
                                    break;
                                case SpeedUnit.MillimetersPerSecond:
                                    format = format.Replace("UUUU", "millimeters per second");
                                    break;
                                case SpeedUnit.StatuteMilesPerHour:
            ...
            catch (Exception ex)
            {
                ...
                throw new ArgumentException(Properties.Resources.Speed_InvalidFormat, ex);
#else
                throw new ArgumentException(RTI.Properties.Resources.Speed_InvalidFormat, "format", ex);
#endif
            }
            //catch
            //{
    ...
    public enum SpeedUnit
    {
        ...
        MetersPerSecond,
        /// <summary>The number of millimeters traveled in one second, also known as MM/S.</summary>
