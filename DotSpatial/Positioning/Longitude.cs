            ...
            try
            {
                ...
                switch (values.Length)
                {
                    ...
                    case 2: // Hours and decimal minutes
                        ...
                        {
                            throw new ArgumentException(RTI.Properties.Resources.Longitude_OnlyRightmostIsDecimal, "value");
                        }
                        // Set decimal degrees
                        _decimalDegrees = ToDecimalDegrees(
...
#else
                throw new ArgumentException(RTI.Properties.Resources.Longitude_InvalidFormat, "value", ex);
#endif
            }
        }
        ...
        public string ToString(string format, IFormatProvider formatProvider)
        {
            ...
            try
            {
                ...
                if (format.IndexOf(culture.NumberFormat.NumberDecimalSeparator) !=
                    ...
                    throw new ArgumentException(RTI.Properties.Resources.Longitude_OnlyRightmostIsDecimal);
