...
#endif
    public struct Position : IFormattable, IEquatable<Position>, ICloneable<Position>
    {
        /// <summary>
        ///
        /// </summary>
...
#else
            throw new ArgumentException(RTI.Properties.Resources.Position_InvalidFormat, "value");
#endif
        }
        ...
        public Distance DistanceTo(Position destination, Ellipsoid ellipsoid, bool isApproximated)
        {
            ...
            if (ellipsoid == null)
                throw new ArgumentNullException("ellipsoid", RTI.Properties.Resources.Position_DistanceTo_Null_Ellipsoid);
