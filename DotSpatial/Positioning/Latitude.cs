    ...
    public struct Latitude : IFormattable, IComparable<Latitude>, IEquatable<Latitude>, ICloneable<Latitude>, IXmlSerializable
    {
            ...
            try
            {
                ...
                switch (values.Length)
                {
                    ...
                    case 1: // Decimal degrees
                        ...
                        // Is it infinity?
                        if (String.Compare(values[0], RTI.Properties.Resources.Common_Infinity, true, culture) == 0)
                        {
                            _decimalDegrees = double.PositiveInfinity;
                            return;
                        }
                        // Is it empty?
                        if (String.Compare(values[0], RTI.Properties.Resources.Common_Empty, true, culture) == 0)
                        {
                            _decimalDegrees = 0.0;
                            return;
                        }
                    ...
                    case 2: // Hours and decimal minutes
                        ...
                        {
                            throw new ArgumentException(RTI.Properties.Resources.Latitude_OnlyRightmostIsDecimal, "value");
                        }
...
#else
                throw new ArgumentException(RTI.Properties.Resources.Latitude_InvalidFormat, "value", ex);
#endif
            }
        }
        ...
        public double DecimalMinutes
        {
            get
            {
                ...
                return Math.Round(
                    (Math.Abs(
                        DecimalDegrees - Truncate(DecimalDegrees)) * 60.0), MAXIMUM_PRECISION_DIGITS - 2);
#endif
            }
        }
...
#else
				return Truncate(DecimalDegrees);
#endif
            }
        }
...
Math.Round(
        ...
        public Latitude ToHemisphere(LatitudeHemisphere hemisphere)
        {
            if (hemisphere == LatitudeHemisphere.None)
                throw new ArgumentException(RTI.Properties.Resources.Latitude_InvalidHemisphere);
...
#else
                throw new ArgumentOutOfRangeException("interval", interval, RTI.Properties.Resources.Angle_InvalidInterval);
#endif
        ...
        public string ToString(string format, IFormatProvider formatProvider)
        {
            ...
            try
            {
                ...
                if (double.IsPositiveInfinity(DecimalDegrees))
                    return "+" + RTI.Properties.Resources.Common_Infinity;
                // Is it infinity?
                ...
                if (format.IndexOf(culture.NumberFormat.NumberDecimalSeparator) !=
                    ...
                    throw new ArgumentException(RTI.Properties.Resources.Latitude_OnlyRightmostIsDecimal);
            ...
            {
                throw new ArgumentException(RTI.Properties.Resources.Angle_InvalidToStringFormat);
            }
        }
