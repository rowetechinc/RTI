...
// | Rico (Rico Castelo)      | 11/22/2011 | Added mm.
// ********************************************************************************************************
using System;
...
namespace DotSpatial.Positioning
{
    ...
    public struct Distance : IFormattable, IComparable<Distance>, IEquatable<Distance>, IXmlSerializable
    {
        ...
        ///
        /// </summary>
        private const double FEET_PER_MILLIMETER = 0.0032808399;
        /// <summary>
        ///
        /// </summary>
        ...
        ///
        /// </summary>
        private const double INCHES_PER_MILLIMETER = 0.0393700787;
        /// <summary>
        ///
        /// </summary>
        ...
        ///
        /// </summary>
        private const double STATUTE_MILES_PER_MILLIMETER = 0.000000621371192;
        /// <summary>
        ///
        /// </summary>
        ...
        ///
        /// </summary>
        private const double NAUTICAL_MILES_PER_MILLIMETER = 0.000000539956803;
        /// <summary>
        ///
        /// </summary>
        ...
        ///
        /// </summary>
        private const double MILLIMETERS_PER_STATUTE_MILE = 1609344;
        /// <summary>
        ///
        /// </summary>
        private const double MILLIMETERS_PER_CENTIMETER = 10;
        /// <summary>
        ///
        /// </summary>
        private const double MILLIMETERS_PER_METER = 1000;
        /// <summary>
        ///
        /// </summary>
        private const double MILLIMETERS_PER_KILOMETER = 1000000;
        /// <summary>
        ///
        /// </summary>
        private const double MILLIMETERS_PER_FOOT = 304.8;
        /// <summary>
        ///
        /// </summary>
        ...
        ///
        /// </summary>
        private const double MILLIMETERS_PER_NAUTICAL_MILE = 1852000;
        ...
        ///
        /// </summary>
        private const double CENTIMETERS_PER_MILLIMETER = 0.1;
        /// <summary>
        ///
        /// </summary>
        ...
        ///
        /// </summary>
        private const double METERS_PER_MILLIMETER = 0.001;
        /// <summary>
        ///
        /// </summary>
        ...
        ///
        /// </summary>
        private const double KILOMETERS_PER_MILLIMETER = 0.000001;
        /// <summary>
        ///
        /// </summary>
        ...
        /// <summary>
        /// Bottom Not Detected in DVL mode.
        /// </summary>
        public static readonly Distance BottomNotDetectedDVL = new Distance(0, DistanceUnit.Millimeters);
        ...
        public Distance(string value, CultureInfo culture)
        {
            ...
            try
            {
...
#else
                    throw new ArgumentException(RTI.Properties.Resources.Distance_InvalidNumericPortion, "value", ex);
#endif
                }
                //catch
                //{
                ...
                if ((unit == "M") || (unit == "M.") || (unit == "METERS") || (unit == "METRES")
                    ...
                    _units = DistanceUnit.Meters;
                else if ((unit == "MM") || (unit == "MM.") || (unit == "MILLIIMETER")
                || (unit == "MILLIIMETERS") || (unit == "MILLIIMETRE") || (unit == "MILLIIMETRES"))
                    _units = DistanceUnit.Millimeters;
                ...
                else
                {
                    ...
                    {
                        throw new ArgumentException(RTI.Properties.Resources.Distance_InvalidUnitPortion, "value");
                    }
                }
...
#else
                throw new ArgumentException(RTI.Properties.Resources.Distance_InvalidFormat, "value", ex);
#endif
            }
            //catch
            //{
        ...
        public Distance ToFeet()
        {
            switch (_units)
            {
                ...
                case DistanceUnit.Millimeters:
                    return new Distance(_value * FEET_PER_MILLIMETER, DistanceUnit.Feet);
        ...
        public Distance ToInches()
        {
            switch (_units)
            {
                ...
                case DistanceUnit.Millimeters:
                    return new Distance(_value * INCHES_PER_MILLIMETER, DistanceUnit.Inches);
                case DistanceUnit.Centimeters:
        ...
        public Distance ToKilometers()
        {
            switch (_units)
            {
                ...
                case DistanceUnit.Millimeters:
                    return new Distance(_value * KILOMETERS_PER_MILLIMETER, DistanceUnit.Kilometers);
                case DistanceUnit.Centimeters:
        ...
        public Distance ToMeters()
        {
            switch (_units)
            {
                case DistanceUnit.Meters:
                    return this;
                case DistanceUnit.Millimeters:
                    return new Distance(_value * METERS_PER_MILLIMETER, DistanceUnit.Meters);
                case DistanceUnit.Centimeters:
        ...
        /// <summary>
        /// Converts the current measurement into millimeters.
        /// </summary>
        /// <returns>A new <strong>Distance</strong> object containing the converted
        /// value.</returns>
        /// <example>
        /// This example converts various distances into meters.  notice that the ToMillimeters method converts distances
        /// from any source type.
        ///   <code lang="VB">
        /// ' Create distances of different unit types
        /// Dim Distance1 As New Distance(10, DistanceUnit.Feet)
        ...
        public Distance ToMillimeters()
        {
            switch (_units)
            {
                case DistanceUnit.Millimeters:
                    return this;
                case DistanceUnit.Meters:
                    return new Distance(_value * MILLIMETERS_PER_METER, DistanceUnit.Millimeters);
                case DistanceUnit.Centimeters:
                    return new Distance(_value * MILLIMETERS_PER_CENTIMETER, DistanceUnit.Millimeters);
                case DistanceUnit.Feet:
                    return new Distance(_value * MILLIMETERS_PER_FOOT, DistanceUnit.Millimeters);
                case DistanceUnit.Inches:
                    return new Distance(_value * MILLIMETERS_PER_INCH, DistanceUnit.Millimeters);
                case DistanceUnit.Kilometers:
                    return new Distance(_value * MILLIMETERS_PER_KILOMETER, DistanceUnit.Millimeters);
                case DistanceUnit.StatuteMiles:
                    return new Distance(_value * MILLIMETERS_PER_STATUTE_MILE, DistanceUnit.Millimeters);
                case DistanceUnit.NauticalMiles:
                    return new Distance(_value * MILLIMETERS_PER_NAUTICAL_MILE, DistanceUnit.Millimeters);
                default:
                    return Empty;
            }
        }
        ...
        public Distance ToCentimeters()
        {
            switch (_units)
            {
                ...
                case DistanceUnit.Millimeters:
                    return new Distance(_value * CENTIMETERS_PER_MILLIMETER, DistanceUnit.Centimeters);
                case DistanceUnit.Feet:
        ...
        public Distance ToNauticalMiles()
        {
            switch (_units)
            {
                ...
                case DistanceUnit.Millimeters:
                    return new Distance(_value * NAUTICAL_MILES_PER_MILLIMETER, DistanceUnit.NauticalMiles);
                case DistanceUnit.Centimeters:
        ...
        public Distance ToStatuteMiles()
        {
            switch (_units)
            {
                ...
                case DistanceUnit.Millimeters:
                    return new Distance(_value * STATUTE_MILES_PER_MILLIMETER, DistanceUnit.StatuteMiles);
                case DistanceUnit.Centimeters:
        ...
        /// <summary>
        /// Froms the millimeters.
        /// </summary>
        /// <param name="value">The value.</param>
        /// <returns></returns>
        /// <remarks></remarks>
        public static Distance FromMillimeters(int value)
        {
...
//			}
        ...
        public string ToString(string format, IFormatProvider formatProvider)
        {
                            ...
                            if (Value == 1)
                            {
                                switch (_units)
                                {
                                    ...
                                    case DistanceUnit.Meters:
                                        ...
                                        break;
                                    case DistanceUnit.Millimeters:
                                        format = format.Replace("UUU", "millimeter");
                                        break;
                                    case DistanceUnit.StatuteMiles:
                            ...
                            else
                            {
                                switch (_units)
                                {
                                    ...
                                    case DistanceUnit.Meters:
                                        ...
                                        break;
                                    case DistanceUnit.Millimeters:
                                        format = format.Replace("UUU", "millimeters");
                                        break;
                                    case DistanceUnit.StatuteMiles:
            ...
            {
                throw new FormatException(RTI.Properties.Resources.Distance_InvalidFormat, ex);
            }
            //catch
            //{
    ...
    public enum DistanceUnit
    {
        ...
        Centimeters,
        /// <summary>Metric System. 1/1000th of a meter.</summary>
        Millimeters,
