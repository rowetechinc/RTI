...
namespace DotSpatial.Positioning
{
    ...
    public struct Angle : IFormattable, IComparable<Angle>, IEquatable<Angle>, ICloneable<Angle>
    {
        /// <summary>
        ///
        /// </summary>
            ...
            try
            {
                ...
                switch (values.Length)
                {
                    ...
                    case 2: // Hours and decimal minutes
                        ...
                        {
                            throw new ArgumentException(RTI.Properties.Resources.Angle_OnlyRightmostIsDecimal, "value");
                        }
...
#else
                throw new ArgumentException(RTI.Properties.Resources.Angle_InvalidFormat, "value", ex);
#endif
            }
        }
        ...
        public string ToString(string format, IFormatProvider formatProvider)
        {
            ...
            try
            {
                ...
                if (format.IndexOf(culture.NumberFormat.NumberDecimalSeparator, StringComparison.Ordinal) !=
                    ...
                    throw new ArgumentException(RTI.Properties.Resources.Angle_OnlyRightmostIsDecimal);
